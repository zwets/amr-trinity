...
> find images in the _Biocontainers registry_, which has "Dockerised" conda
> environments of the tools.
...
Outputs and generated are the same as described in the
[snakemake-conda README](../snakemake-conda/README.md).
